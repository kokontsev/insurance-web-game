...
import decorSuccess from "../assets/outcomes/decor-success.png";
import decorSad from "../assets/outcomes/decor-sad.png";

import phoneSuccess from "../assets/outcomes/phone-success.png";
import phoneSad from "../assets/outcomes/phone-sad.png";
import skateSuccess from "../assets/outcomes/skate-success.png";
import skateSad from "../assets/outcomes/skate-sad.png";
import accountSuccess from "../assets/outcomes/account-success.png";
import accountSad from "../assets/outcomes/account-sad.png";
import concertSuccess from "../assets/outcomes/concert-success.png";
import concertSad from "../assets/outcomes/concert-sad.png";
import tripSuccess from "../assets/outcomes/trip-success.png";
import tripSad from "../assets/outcomes/trip-sad.png";
import scooterSuccess from "../assets/outcomes/scooter-success.png";
import scooterSad from "../assets/outcomes/scooter-sad.png";
...
const successImages = {
  phone: phoneSuccess,
  skate: skateSuccess,
  account: accountSuccess,
  concert: concertSuccess,
  trip: tripSuccess,
  scooter: scooterSuccess,
};
...
function OutcomePage() {
  ...
  const decorImage = isSuccess ? decorSuccess : decorSad;
  const innerImage = isSuccess ? successImages[id] : sadImages[id];
  const backgroundColor = isSuccess ? "#5CFF92" : "#FF5C5D";
      ...
      <div style={{ ...styles.sceneWrapper, width: DESIGN_WIDTH * scale, height: DESIGN_HEIGHT * scale }}>
        <div style={{ ...styles.scene, transform: `scale(${scale})` }}>
          <Header
            ...
            insuranceLabel={result.insuranceLabel}
            navigate={navigate}
          ...
          <img
            src={decorImage}
            alt=""
            style={isSuccess ? styles.decorSuccess : styles.decorSad}
          />

          <div style={{ ...styles.resultCard, backgroundColor }}>
            ...
            <div style={styles.innerCard}>
              ...
              <div style={styles.innerImageArea}>
                <img src={innerImage} alt="" style={styles.innerImage} />
              </div>
